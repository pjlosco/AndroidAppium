...
public class GlobalLocators {
    ...
    public static final LayoutLocator CurrentTitle = new LayoutLocator("CurrentTitle", "//window[1]/navigationBar[1]/text[1]", "");
    ...
    public static final LayoutLocator NoLongerInGroupAlert = new LayoutLocator("NoLongerInGroupAlert", "//window[2]/toolbar[1]/text[1]", "You are no longer in this group.");
}
